...
public Ghafar07198_AllObjectModel allObject =new Ghafar07198_AllObjectModel();
    ...
    public int hapus(String email){
        return allObject.UserModel.hapusnama(email);
    }
    @Override
    ...
    public void InsertDataTabungan(int Ghafar07198_jangkawaktuterkumpul1, int Ghafar07198_target, int Ghafar07198_menabung, int Ghafar07198_sekalamenabung,Calendar tgl){
    ...
    public Ghafar07198_DataTabunganEntity Ghafar07198_TabunganPintar(int index){
        return allObject.TabunganPintar.Ghafar07198_TabunganPintar(index);
    }
    public int Ghafar07198_hapusTabungan(int Target){
        return allObject.TabunganPintar.Ghafar07198_hapus(Target);
    }
}
